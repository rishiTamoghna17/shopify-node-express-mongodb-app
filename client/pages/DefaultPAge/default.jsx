      ...
      <div>
       ...
       { isLogin===true?<ConversationScreen
        ...
        <section className="section-detail-conversation">
          {isLogin===true?<LoggedInDetailConversation width="20%" section3="80%" merchantLogo={<BiLogoWindows color="red" size="30px" />}/>:<DetailConversation width="20%" section3="80%" merchantLogo={<BiLogoWindows color="red" size="30px" />}/>}
        </section>
      </div>
    </Page>
  );
